# symphony-monitor.spec Upstream Metadata

This directory vendors third-party specification content from `siisee11/symphony-monitor.spec`.

## Upstream repository

- Repository: `https://github.com/siisee11/symphony-monitor.spec`
- Source branch/reference fetched: `main`
- Resolved commit at fetch time (2026-03-20): `43e48faac68c28f5164005ce4713982075f54df0`
